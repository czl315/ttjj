...
public class Ttjj_005224_广发中证基建工程指数C {

    public static void main(String[] args) {
        String name = "广发中证基建工程指数C(005224)";
        String canShare = "707.11";
        String BUY_COST = "500";
        String FIRST_NET_DATA = "2020-03-27";
        String TRADE_ID = "00";
        String FD_ID = "00";
        String SOURCE = "3";

        Map<String, String> pramaMap = new HashMap<String, String>();
        pramaMap.put(Content.jjCode, "005224");
        pramaMap.put(Content.startDate, "2020-03-26");
