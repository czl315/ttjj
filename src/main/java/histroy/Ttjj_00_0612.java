...
//        String endDateToday = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
        String startDate = "2020-06-11";
        String endDate = "2020-06-12";
//        {
...
//                    "2275.69", "2300.00", "2020-04-20", "00", "00", "0"));
//
...
//
//            paramList.add(handlertTtjjHasSxf("2020-06-11", "2020-06-12", "110022", "110022|易方达消费行业股票",
//                    "962.93", "2800", "2020-03-31", "00", "00", "0.30"));
//
//            paramList.add(handlertTtjjHasSxf(startDate, endDate, "160225", "160225|国泰国证新能源汽车指数",
//                    "1355.75", "1200", "2020-03-30", "00", "00", "0"));
//
//            paramList.add(handlertTtjjHasSxf("2020-06-11", "2020-06-12",  "160633", "160633|鹏华证券分级",
//                    "3164.39", "3000.00", "2020-03-10", "00", "00", "0.24"));
//
...
//
//            paramList.add(handlertTtjjHasSxf("2020-06-11", "2020-06-12", "161725", "161725|招商中证白酒指数分级",
//                    "1922.66", "1800", "2020-04-07", "00", "00", "0.20"));
//
...
//        }
        ...
        {
            String startDateQdii = "2020-06-04";//qdii晚一天出
            String endDateQdii = "2020-06-12";
