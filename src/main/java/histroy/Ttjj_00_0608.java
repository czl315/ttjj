...
//        String endDateToday = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
        ...
        String endDate = "2020-06-08";
        {
            ...
            paramList.add(handlertTtjjHasSxf("2020-06-05", "2020-06-08", "001875", "001875|前海开源沪港深优势精选混合",
                    "548.92", "1000", "2020-04-22", "00", "00", "0.30"));
            paramList.add(handlertTtjjHasSxf("2020-06-08", endDate, "001875", "001875|前海开源沪港深优势精选混合",
            ...
            paramList.add(handlertTtjjHasSxf("2020-06-05", "2020-06-08", "002207", "002207|前海开源金银珠宝混合C",
                "2076.19", "2100", "2020-04-20", "00", "00", "0.30"));
            paramList.add(handlertTtjjHasSxf("2020-06-08", endDate, "002207", "002207|前海开源金银珠宝混合C",
