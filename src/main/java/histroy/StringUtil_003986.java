...
public class StringUtil_003986 {

    public static void main(String[] args) {
        String name = "申万菱信中证500指数优选增强A(003986)";
        String canShare = "74.63";
        String BUY_COST = "100";
        ...
        String backString = "<tbody>" +
                ...
                "                  <tr class=\"\">" +
                "                      <td>2020-03-13</td>" +
                "                      <td class=\"tor bold\">1.2895" +
                "                            " +
                "                      </td>" +
                "" +
                "                      " +
                "                          <td class=\"tor bold\">1.3775</td>" +
                "                      <td class=\"tor bold grn\">-0.91%</td>" +
                "                      " +
                "                          " +
                "                        <td>开放申购</td>" +
                "                      <td>开放赎回</td>" +
                ...
                "                  <tr class=\"\">" +
                "                      <td>2020-03-12</td>" +
                "                      <td class=\"tor bold\">1.3013" +
                "                            " +
                "                      </td>" +
                "" +
                "                      " +
                "                          <td class=\"tor bold\">1.3893</td>" +
                "                      <td class=\"tor bold grn\">-1.68%</td>" +
                "                      " +
                "                          " +
                "                        <td>开放申购</td>" +
                "                      <td>开放赎回</td>" +
                ...
                "                  <tr class=\"\">" +
                "                      <td>2020-03-11</td>" +
                "                      <td class=\"tor bold\">1.3236" +
                "                            " +
                "                      </td>" +
                "" +
                "                      " +
                "                          <td class=\"tor bold\">1.4116</td>" +
                "                      <td class=\"tor bold grn\">-1.10%</td>" +
                "                      " +
                "                          " +
                "                        <td>开放申购</td>" +
                "                      <td>开放赎回</td>" +
