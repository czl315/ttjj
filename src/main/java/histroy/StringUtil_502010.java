...
public class StringUtil_502010 {
    ...
    public static void main(String[] args) {
        ...
        String backString = "<tbody>" +
                ...
                "                  <tr class=\"\">" +
                "                      <td>2020-03-13</td>" +
                "                      <td class=\"tor bold\">1.1004" +
                "                            " +
                "                      </td>" +
                "" +
                "                      " +
                "                          <td class=\"tor bold\"></td>" +
                "                      <td class=\"tor bold grn\">-0.59%</td>" +
                "                      " +
                "                          " +
                "                        <td>限制大额申购</td>" +
                "                      <td>开放赎回</td>" +
                ...
                "                  <tr class=\"\">" +
                "                      <td>2020-03-11</td>" +
                "                      <td class=\"tor bold\">1.1198" +
                "                            " +
                "                      </td>" +
                "" +
                "                      " +
                "                          <td class=\"tor bold\"></td>" +
                "                      <td class=\"tor bold grn\">-2.81%</td>" +
                "                      " +
                "                          " +
                "                        <td>限制大额申购</td>" +
                "                      <td>开放赎回</td>" +
                ...
                "                  <tr class=\"\">" +
                "                      <td>2020-03-10</td>" +
                "                      <td class=\"tor bold\">1.1522" +
                "                            " +
                "                      </td>" +
                "" +
                "                      " +
                "                          <td class=\"tor bold\"></td>" +
                "                      <td class=\"tor bold red\">3.10%</td>" +
                "                      " +
                "                          " +
                "                        <td>限制大额申购</td>" +
                "                      <td>开放赎回</td>" +
