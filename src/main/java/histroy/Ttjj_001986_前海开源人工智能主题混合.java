...
public class Ttjj_001986_前海开源人工智能主题混合 {

    public static void main(String[] args) {
        String name = "前海开源人工智能主题混合(001986)";
        String canShare = "79.44";
        String BUY_COST = "100";
        String FIRST_NET_DATA = "2020-03-26";
        String TRADE_ID = "00";
        String FD_ID = "00";
        String SOURCE = "3";

        Map<String, String> pramaMap = new HashMap<String, String>();
        pramaMap.put(Content.jjCode, "001986");
        pramaMap.put(Content.startDate, "2020-03-25");
