...
//        String endDateToday = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
        ...
        {
        paramList.add(handlertTtjjHasSxf(startDate, "2020-06-18", "164402", "前海开源中航军工(164402)",
                "408.76", "444.79", "2019-09-09", "12", "13", "0"));
            paramList.add(handlertTtjjHasSxf("2020-06-18", "2020-06-19", "164402", "前海开源中航军工(164402)",
                    "0", "0", "2019-09-09", "12", "13", "2.05"));
        }
...
//        paramList.add(handlertTtjjHasSxf(startDate, "2020-06-08", "003860", "003860|招商招旭纯债C",
