...
//        String endDateToday = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
        ...
        {
            paramList.add(handlertTtjjHasSxf("2020-06-05", "2020-06-08", "003547", "003547|鹏华丰禄债券",
                    "23003.67", "24500", "2020-03-11", "51", "27", "0.08"));
            paramList.add(handlertTtjjHasSxf("2020-06-08", endDate, "003547", "003547|鹏华丰禄债券",
