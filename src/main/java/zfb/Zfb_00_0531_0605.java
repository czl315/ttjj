...
//        String endDateToday = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
        ...
        {
            paramList.add(handlertTtjjHasSxf("2020-05-29", "2020-06-01", "003547", "003547|鹏华丰禄债券",
                    "22451.85", "24000", "2020-03-11", "51", "27", "0.08"));
            paramList.add(handlertTtjjHasSxf("2020-06-01", "2020-06-02", "003547", "003547|鹏华丰禄债券",
                    "22543.85", "24100", "2020-03-11", "51", "27", "0.08"));
            paramList.add(handlertTtjjHasSxf("2020-06-02", "2020-06-03", "003547", "003547|鹏华丰禄债券",
                    "22635.85", "24200", "2020-03-11", "51", "27", "0.08"));
            paramList.add(handlertTtjjHasSxf("2020-06-03", "2020-06-04", "003547", "003547|鹏华丰禄债券",
                    "22727.85", "24300", "2020-03-11", "51", "27", "0.08"));
            paramList.add(handlertTtjjHasSxf("2020-06-04", "2020-06-05", "003547", "003547|鹏华丰禄债券",
                    "22911.45", "24400", "2020-03-11", "51", "27", "0.08"));
        ...
        /*{
            ...
            String startDateQdii = "2020-05-28";
