...
//        String endDateToday = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
        String startDate = "2020-06-22";
        String endDate = "2020-06-23";
//        {
...
//                    "735.97", "891.13", "2020-04-16", "00", "00", "0"));
//
...
//                    "892.74", "1000.00", "2020-03-30", "00", "00", "1.20"));
//
//            paramList.add(handlertTtjjHasSxf(startDate, endDate, "160633", "160633|鹏华证券分级",
//                    "3875.42", "3700.00", "2020-03-10", "00", "00", "0.60"));
//
...
//                    "2366.74", "2300.00", "2020-04-07", "00", "00", "0.50"));
//
...
//                    "489.13", "500.00", "2020-06-23", "00", "00", "0.60"));
//
...
//                    "1511.57", "1600.00", "2020-03-10", "00", "00", "0"));
//
...
//
//                        paramList.add(handlertTtjjHasSxfType("2020-06-15", "2020-06-16", "160416", "160416|华安标普全球石油指数",
//                    "346.40", "300", "2020-06-16", "00", "00", "0.36", "QDII"));
//            paramList.add(handlertTtjjHasSxfType("2020-06-16", "2020-06-17", "160416", "160416|华安标普全球石油指数",
//                    "346.40", "300", "2020-06-16", "00", "00", "0", "QDII"));
//            paramList.add(handlertTtjjHasSxfType("2020-06-17", "2020-06-18", "160416", "160416|华安标普全球石油指数",
//                    "911.33", "800", "2020-06-16", "00", "00", "0.6", "QDII"));
//        }
