...
//                    System.out.println("均线价格暂不更新（100亿以下）！" + JSON.toJSONString(entity));
                ...
                if (entity.getF139() == DB_RANK_BIZ_F139_BAN_KUAI) {
                    ...
                    if (isMa5) {
                        ...
                        maSb.append(" 5日:").append(handlerAvgLine(KlineService.findNetMinMaxAvg(zqdm, MA_5, KLT_101, false, "", date, KLINE_TYPE_STOCK)));
                    }
                    if (isMa10) {
                        ...
                        maSb.append("10日:").append(handlerAvgLine(KlineService.findNetMinMaxAvg(zqdm, MA_10, KLT_101, false, "", date, KLINE_TYPE_STOCK)));
                    }
                    if (isMa20) {
                        ...
                        maSb.append("20日:").append(handlerAvgLine(KlineService.findNetMinMaxAvg(zqdm, MA_20, KLT_101, false, "", date, KLINE_TYPE_STOCK)));
                    }
                    if (isMa30) {
                        ...
                        maSb.append(" 30日:").append(handlerAvgLine(KlineService.findNetMinMaxAvg(zqdm, MA_30, KLT_101, false, "", date, KLINE_TYPE_STOCK)));
                    }
                    if (isMa60) {
                        ...
                        maSb.append(" 60日:").append(handlerAvgLine(KlineService.findNetMinMaxAvg(zqdm, MA_60, KLT_101, false, "", date, KLINE_TYPE_STOCK)));
                    }
                    if (isMa120) {
                        ...
                        maSb.append(" 120日:").append(handlerAvgLine(KlineService.findNetMinMaxAvg(zqdm, MA_120, KLT_101, false, "", date, KLINE_TYPE_STOCK)));
                    }
                    if (isMa250) {
                        ...
                        maSb.append(" 250日:").append(handlerAvgLine(KlineService.findNetMinMaxAvg(zqdm, MA_250, KLT_101, false, "", date, KLINE_TYPE_STOCK)));
                    }
//                    System.out.println();
