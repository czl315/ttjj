...
//        String conceptions = "租售同权";//金融-房地产：租售同权
...
//        String conceptions = "PVDF概念";//新能源-锂电池：盐湖提锂,PVDF概念,刀片电池,固态电池,钠离子电池,动力电池回收,锂电池,氟化工   ["盐湖提锂"];股票个数：18;["PVDF概念"]：5;
        String conceptions = "数字货币,跨境支付,电子身份证";//科技-数字经济:数字货币,跨境支付,电子身份证,eSIM,数据安全,数字经济,区块链        互联金融,智慧政务,网络安全,
//        String conceptions = "新冠检测,新冠药物,体外诊断";//新冠检测,新冠药物,体外诊断     肝素概念,幽门螺杆菌概念,重组蛋白,基因测序,超级真菌
...
//        String conceptions = "预制菜概念";//农业养殖：转基因,鸡肉概念,水产养殖,猪肉概念,预制菜概念,农业种植
