...
//        String conceptions = "租售同权";//金融-房地产：租售同权,装配建筑,民爆概念,REITs概念,建筑节能,地下管网,海绵城市,工程机械概念,水利建设,滨海新区,赛马概念
        String conceptions = "低碳冶金";//资源-钢铁：低碳冶金,基本金属,稀缺资源,稀土永磁,钛白粉
//        String conceptions = "转基因";//资源-农业: 转基因,水产养殖,农业种植,鸡肉概念,猪肉概念,化工原料,草甘膦,蝗虫防治,生态农业,
//        String conceptions = "券商概念";//金融-券商:券商概念,互联金融,参股期货
//        String conceptions = "地塞米松";//医疗-制药：地塞米松,疫苗冷链,阿兹海默,
//        String conceptions = "预制菜概念";//消费-食品: 预制菜概念,社区团购,乳业,调味品概念
//        String conceptions = "进口博览";//消费-物流:统一大市场,快递概念,中俄贸易概念,海洋经济,RCEP概念
//        String conceptions = "白酒";//消费-酒:白酒,啤酒概念
//        String conceptions = "工业4.0";//科技-工业: 工业母机,工业4.0
//        String conceptions = "盐湖提锂";//新能源-锂电池：盐湖提锂,刀片电池,固态电池,钠离子电池,动力电池回收,锂电池,氟化工   ["盐湖提锂"];股票个数：18;["PVDF概念"]：5;["氟化工"]：21;
//        String conceptions = "CAR-T细胞疗法";//医疗-创新药：CRO,青蒿素,CAR-T细胞疗法

//        String conceptions = "网络游戏";//科技-传媒：云游戏,手游概念,电子竞技,网络游戏,
//        String conceptions = "在线旅游";//消费-旅游:在线旅游,退税商店,免税概念,航空机场,盲盒经济,影视概念
//        String conceptions = "数字货币";//科技-数字经济:数字货币,eSIM,电子身份证,华为昇腾,数字经济,跨境支付,电子车牌,ETC,移动支付,数据安全,区块链,京东金融,抖音小店         ["eSIM"]：5;
//        String conceptions = "国资云概念";//东数西算,国资云概念,VPN,数据中心,云计算,边缘计算,智慧政务,网络安全
...
//        String conceptions = "长寿药";//医疗-中药：肝素概念,长寿药,独家药品,中药概念,流感,超级真菌,阿兹海默        ["中药概念"]：80;
//        String conceptions = "疫苗冷链";//医疗-新冠：新冠检测,新冠药物,体外诊断
