...
//        String conceptions = "免税概念";//消费-旅游:免税概念,在线旅游,退税商店,航空机场,盲盒经济,影视概念
//        String conceptions = "低碳冶金";//资源-钢铁：低碳冶金,稀缺资源,基本金属,稀土永磁,钛白粉
//        String conceptions = "煤化工";//资源-煤炭：煤化工
//        String conceptions = "京津冀";//金融-房地产：租售同权,装配建筑,赛马概念,民爆概念,REITs概念,建筑节能,地下管网,海绵城市,工程机械概念,水利建设,滨海新区,京津冀
//        String conceptions = "啤酒概念";//消费-酒:白酒,啤酒概念
//        String conceptions = "人造肉";//消费-食品: 预制菜概念,调味品概念,社区团购,乳业,人造肉
//        String conceptions = "水产养殖";//资源-农业: 鸡肉概念,转基因,水产养殖,农业种植,猪肉概念,化工原料,草甘膦,蝗虫防治,生态农业,
//        String conceptions = "绿色电力";//科技-电力:特高压,抽水蓄能,绿色电力,风能,虚拟电厂
...
//        String conceptions = "固态电池";//新能源-锂电池：盐湖提锂,刀片电池,固态电池,钠离子电池,动力电池回收,锂电池,氟化工   ["盐湖提锂"];股票个数：18;["PVDF概念"]：5;["氟化工"]：21;
//        String conceptions = "胎压监测";//科技-军工: 航母概念,海工装备,军民融合,大飞机,通用航空,天基互联,航天概念,空间站概念,北斗导航,
//        String conceptions = "华为汽车";//科技-汽车: 激光雷达,胎压监测
//        String conceptions = "汽车芯片";//科技-芯片：中芯概念,汽车芯片,IGBT概念,第三代半导体,PVDF概念,光刻胶,半导体概念,
//        String conceptions = "东数西算";//东数西算,国资云概念,VPN,数据中心,云计算,边缘计算,智慧政务,网络安全
        String conceptions = "统一大市场";//消费-物流:统一大市场,快递概念,中俄贸易概念,海洋经济,RCEP概念

//        String conceptions = "人脑工程";//科技-智能: 人脑工程
//        String conceptions = "毛发医疗";//医疗-医美：毛发医疗,医疗美容,

//        String conceptions = "券商概念";//金融-券商:券商概念,互联金融,参股期货
//        String conceptions = "工业4.0";//科技-工业: 工业母机,工业4.0

//        String conceptions = "网络游戏";//科技-传媒：云游戏,手游概念,电子竞技,网络游戏,
//        String conceptions = "数字货币";//科技-数字经济:数字货币,eSIM,电子身份证,华为昇腾,数字经济,跨境支付,电子车牌,ETC,移动支付,数据安全,区块链,京东金融,抖音小店         ["eSIM"]：5;
//        String conceptions = "磷化工";//资源-化工: 磷化工,

//        String conceptions = "NFT概念";//科技-传媒：NFT概念,虚拟数字人,快手概念,手游概念,华为欧拉,鸿蒙概念,广电,元宇宙概念,盲盒经济
