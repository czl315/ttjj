...
SELECT
	...
	,ROUND((ol_fund_trade.NET_MAX_1 / ol_fund_trade.NET_MAX_30) * 100,2) AS 净值最大30
	,ROUND((ol_fund_trade.NET_MAX_1 / ol_fund_trade.NET_MAX_60) * 100,2) AS 净值最大60
	,ROUND((ol_fund_trade.NET_MAX_1 / ol_fund_trade.NET_MAX_90) * 100,2) AS 净值最大90
	,ROUND((ol_fund_trade.NET_MAX_1 / ol_fund_trade.NET_MAX_180) * 100,2) AS 净值最大180
	,ROUND((ol_fund_trade.NET_MAX_1 / ol_fund_trade.NET_MAX_360) * 100,2) AS 净值最大360
...
ORDER BY 净值最大30 DESC
-- ORDER BY 涨幅30 DESC
;

/**周期净值比率-n天**/
SELECT
	ol_fund_trade.FD_INFO AS 涨幅30
	,ROUND((ol_fund_trade.NET_MAX_1 / ol_fund_trade.NET_MAX_30) * 100,2) AS 净值最大30
	,ROUND((ol_fund_trade.NET_MAX_1 / ol_fund_trade.NET_MAX_60) * 100,2) AS 净值最大60
	,ROUND((ol_fund_trade.NET_MAX_1 / ol_fund_trade.NET_MAX_90) * 100,2) AS 净值最大90
	,ROUND((ol_fund_trade.NET_MAX_1 / ol_fund_trade.NET_MAX_180) * 100,2) AS 净值最大180
...
WHERE 	1 = 1 AND ol_fund_trade.SOURCE=3 AND ol_fund_trade.TRADE_TIME>='2020-01-01 00:00:00'
	AND ol_fund_trade.TYPE = '申购'
-- GROUP BY ol_fund_trade.FD_INFO
ORDER BY 净值最大30 DESC ,ol_fund_trade.FD_INFO DESC
-- ORDER BY 涨幅30 DESC
;
