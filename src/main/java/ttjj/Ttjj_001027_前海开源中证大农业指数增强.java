...
public class Ttjj_001027_前海开源中证大农业指数增强 {

    public static void main(String[] args) {
        String name = "前海开源中证大农业指数增强(001027)";
        String canShare = "96.88";
        String BUY_COST = "500";
        ...
        pramaMap.put(Content.jjCode, "001027");
        pramaMap.put(Content.startDate, "2020-03-30");
