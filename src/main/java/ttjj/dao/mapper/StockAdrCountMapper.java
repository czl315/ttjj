...
public interface StockAdrCountMapper {
    ...
    @Insert({"<script>",
            ...
            ", `f139`, `f62`",
            ", `ADR_UP_SUM_1_5`, `ADR_UP_SUM_1_10`, `ADR_UP_SUM_1_20`, `ADR_UP_SUM_20_40`, `ADR_UP_SUM_40_60`",
            ", `ADR_UP_SUM_ORDER_1_5`, `ADR_UP_SUM_ORDER_1_10`, `ADR_UP_SUM_ORDER_1_20`, `ADR_UP_SUM_ORDER_20_40`, `ADR_UP_SUM_ORDER_40_60`",
            ") VALUES (",
            "#{date},#{type_name},#{f2},#{f3},#{f4}",
            ",#{f5},#{f6},#{f7},#{f8},#{f9}",
            ",#{f10},#{f12},#{f14},#{f15},#{f16}",
