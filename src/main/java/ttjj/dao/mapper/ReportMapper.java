...
public interface ReportMapper {
    ...
    @Insert({"<script>",
            "INSERT INTO `bank19`.`report`(",
                ...
                " `SECURITY_TYPE`,`UPDATE_DATE`, `REPORTDATE`, `BASIC_EPS`, `DEDUCT_BASIC_EPS`, ",
                " `TOTAL_OPERATE_INCOME`,`PARENT_NETPROFIT`, `WEIGHTAVG_ROE`, `YSTZ`, `SJLTZ`, ",
                " `BPS`,`MGJYXJJE`, `XSMLL`, `YSHZ`, `SJLHZ`, ",
