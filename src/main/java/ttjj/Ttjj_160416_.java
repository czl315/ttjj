...
public class Ttjj_160416_ {

    public static void main(String[] args) {
        String name = "华安标普全球石油指数(160416)";
        String canShare = "166.19";
        String BUY_COST = "100";
        String FIRST_NET_DATA = "2020-03-19";
        String TRADE_ID = "00";
        String FD_ID = "00";
        String SOURCE = "3";

        Map<String, String> pramaMap = new HashMap<String, String>();
        pramaMap.put(Content.jjCode, "160416");
        pramaMap.put(Content.startDate, "2020-03-17");
