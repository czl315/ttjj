...
public class Ttjj_006021_ {

    public static void main(String[] args) {
        String name = "广发沪深300指数增强C(006021)";
        String canShare = "168.52";
        String BUY_COST = "200";
        String FIRST_NET_DATA = "2020-03-17";
        String TRADE_ID = "00";
        String FD_ID = "00";
        String SOURCE = "3";

        Map<String, String> pramaMap = new HashMap<String, String>();
        pramaMap.put(Content.jjCode, "006021");
        pramaMap.put(Content.startDate, "2020-03-16");
