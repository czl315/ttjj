...
public class StringUtil_007405 {

    public static void main(String[] args) {
        String name = "华宝中证100指数C(007405)";
        String canShare = "67.29";
        String BUY_COST = "100";
        ...
        String backString = "<tbody>" +
                ...
                "                  <tr class=\"\">" +
                "                      <td>2020-03-13</td>" +
                "                      <td class=\"tor bold\">1.4638" +
                "                            " +
                "                      </td>" +
                "" +
                "                      " +
                "                          <td class=\"tor bold\">1.4638</td>" +
                "                      <td class=\"tor bold grn\">-1.49%</td>" +
                "                      " +
                "                          " +
                "                        <td>开放申购</td>" +
                "                      <td>开放赎回</td>" +
