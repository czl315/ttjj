 ...
 * 新品季
 */
public class NhjXjkTyjSend200 extends TimerTask {
    private final static Logger logger = Logger.getLogger(NhjXjkTyjSend200.class);
    private static int tempStep = 290;//207
