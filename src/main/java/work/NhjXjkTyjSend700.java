 ...
 * 新品季
 */
public class NhjXjkTyjSend700 extends TimerTask {
    private final static Logger logger = Logger.getLogger(NhjXjkTyjSend700.class);
    private static int tempStep = 700;
