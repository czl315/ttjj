 ...
 * 新品季
 */
public class NhjXjkTyjSend100 extends TimerTask {
    private final static Logger logger = Logger.getLogger(NhjXjkTyjSend100.class);
    private static int tempStep = 190;//200
