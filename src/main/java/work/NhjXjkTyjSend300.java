 ...
 * 新品季
 */
public class NhjXjkTyjSend300 extends TimerTask {
    private final static Logger logger = Logger.getLogger(NhjXjkTyjSend300.class);
    private static int tempStep = 395;
