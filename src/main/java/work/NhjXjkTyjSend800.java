 ...
 * 新品季
 */
public class NhjXjkTyjSend800 extends TimerTask {
    private final static Logger logger = Logger.getLogger(NhjXjkTyjSend800.class);
    private static int tempStep = 800;//900
