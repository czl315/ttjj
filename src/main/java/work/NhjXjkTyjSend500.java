 ...
 * 新品季
 */
public class NhjXjkTyjSend500 extends TimerTask {
    private final static Logger logger = Logger.getLogger(NhjXjkTyjSend500.class);
    private static int tempStep = 590;//600
