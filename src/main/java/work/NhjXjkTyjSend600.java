 ...
 * 新品季
 */
public class NhjXjkTyjSend600 extends TimerTask {
    private final static Logger logger = Logger.getLogger(NhjXjkTyjSend600.class);
    private static int tempStep = 600;
